...
const Navbar = () => {
    ...
    return(
        <div style={{'width':'90%','margin':'0 auto'}}>
            <nav className={[Theme ? NavbarCSS.dark : NavbarCSS.light, NavbarCSS.Navbar, 'p-4'].join(' ')}>
                <h1>
                ...
                <ul>
                    ...
                    <li onClick={() => setDrop(!drop)}>
                        <img src='https://tvline.com/wp-content/uploads/2023/04/succession-season-4-episode-6-kendall-roy.png?w=620' alt='profile'/>
                        <div className={[Theme ? NavbarCSS.drop : NavbarCSS.dropLight, 'p-2'].join(' ')} style={{display: drop ? 'block' : 'none'}}>
                    ...
                    <button className='mx-2' onClick={changeTheme}>
